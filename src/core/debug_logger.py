...
class DebugLogger:
    ...
    def __init__(self):
        ...
        # Default to enabled so issues (cookie injection, CDP errors, etc.) are
        # observable via the MCP `get_debug_view()` tool without requiring a
        # server restart or CLI flag.
        self._enabled = True
