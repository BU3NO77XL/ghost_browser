        ...
        return [
            {
                ...
                "requirements": {"url_pattern": "*doubleclick.net*"},
                "function": """
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*/convert-to-post*", "method": "GET"},
                "function": """
def process_request(request):
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*/mock-api/*"},
                "function": """
def process_request(request):
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*"},  # Match all URLs
                "function": """
def process_request(request):
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*old-domain.com*"},
                "function": """
def process_request(request):
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*important-api*"},
                "function": """
def process_request(request):
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*api/*", "stage": "response"},
                "function": """
def process_request(request):
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*", "stage": "response"},
                "function": """
def process_request(request):
...
""",
            ...
            },
            {
                ...
                "requirements": {"url_pattern": "*api/users*", "stage": "response"},
                "function": """
def process_request(request):
    # Only process responses
    if request.get("stage") != "response":
