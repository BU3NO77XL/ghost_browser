...
class TestConcurrentAccess:
    ...
    async def test_concurrent_register_and_check(self, browser_tab):
        ...
        register_tasks = [
            manual_login_handler.register_pending_login(
                instance_id, browser_tab, f"https://test.com/{instance_id}"
            )
        ...
        check_tasks = [
            manual_login_handler.is_pending_login(instance_id) for instance_id in instance_ids
        ]
    ...
    async def test_concurrent_clear_operations(self, browser_tab):
        ...
        clear_tasks = [
            manual_login_handler._clear_pending(instance_id) for instance_id in instance_ids
        ]
